...
insert into at_client (name,token,user_id,local_host,local_port) values('client_gao','abcxxx','1','127.0.0.1','9999'); 
...
insert into at_server (name,token,user_id) values('server_gao','abcxxx',0); 
...
insert into at_tunnel (mode,name,cluster_id,protocol,server_id,client_id,server_listen_port,server_listen_ip,client_local_port,client_local_host,status,is_open) values(0,'tunnel_1',3,1,1,1,8888,'127.0.0.1',9999,'127.0.0.1',1,1);
