...
func initConfig() (err error) {
	...
	cfg.SetDefault("url", "https://124.89.116.203:29531/cluster/get")
	cfg.SetDefault("host", "124.89.116.203")
	cfg.SetDefault("httpaddr","10.100.93.52")
	...
	pflag.String("token", "AX2Gf3Vav53Ewi0Npp8MuM2ZpCTv3E4x", "token of client connect to cluster")
